...
public class UtilLib {
	 ...
	 * the targeted face.
	 */
	public static void area331(World world,
			BlockPos pos,
			PlayerEntity player,
	...
	public static HitResult calcRayTraceCollide(World worldIn, PlayerEntity player,
			RaycastContext.FluidHandling fluidMode, double addition) {
		...
		Vec3d vector3d1 = vector3d.add((double) f6 * d0, (double) f5 * d0, (double) f7 * d0);
		return worldIn
				.raycast(new RaycastContext(vector3d, vector3d1, RaycastContext.ShapeType.COLLIDER, fluidMode, player));
	}
}
