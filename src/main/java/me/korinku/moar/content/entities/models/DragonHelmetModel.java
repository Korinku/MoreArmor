package me.korinku.moar.content.entities.models;
...
public class DragonHelmetModel extends Model {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData modelPartData1 = modelPartData.addChild("root",
				ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.1F))
						.uv(0, 16).cuboid(-3.0F, -7.0F, -7.0F, 6.0F, 4.0F, 3.0F),
				ModelTransform.pivot(0.0F, 24.0F, 0.0F));
		modelPartData1.addChild("HornLD",
				ModelPartBuilder.create().uv(34, 0).cuboid(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 4.0F),
				ModelTransform.pivot(-3.0F, -5.0F, 3.0F));
		modelPartData1.addChild("HornRD",
				ModelPartBuilder.create().uv(34, 0).cuboid(-2.0F, -1.0F, 0.0F, 2.0F, 2.0F, 4.0F),
				ModelTransform.pivot(4.0F, -5.0F, 3.0F));
		modelPartData1
				.addChild(
						"HornLU", ModelPartBuilder.create().uv(24, 0).cuboid(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 6.0F)
								.uv(24, 0).cuboid(4.8F, 0.0F, 0.0F, 2.0F, 2.0F, 6.0F),
						ModelTransform.pivot(-2.9F, -8.0F, 2.0F));
